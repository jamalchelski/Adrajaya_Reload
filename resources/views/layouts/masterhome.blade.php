    ...
    <div id="app" >
        ...
        <div class="container-fluid bg-white shadow-sm navut" >
            ...
            <div class="d-flex flex-row-reverse bd-highlight">
                ...
                <div class="p-2 bd-highlight ">
                    <a class="text-dark mr-5 mt-2 tbl {{ Request::is('/') ? 'border border-info rounded-pill px-2  ' : ''}}" href="{{ route('/') }}">Beranda</a>
                </div>
            </div>
        </div>
        </div>
            ...
            <div class="container mt-5 " style="height: 700px;">
                <div class="row">
                    ...
                    <div class="col-9">
                        ...
                        {{-- CONTENT BUTTOM --}}
                        <div class="container bg-white  shadow-sm img-thumbnail hcontent" >
