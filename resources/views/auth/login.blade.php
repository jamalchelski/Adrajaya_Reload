...
<div class="container pt-5 pb-5" style="margin-bottom: 90px"  >
    <div class="row ">
        <div class="col-6 text-center mt-5">
            <img src="https://res.cloudinary.com/http-adrajaya-com-dev/image/upload/v1585345324/adrajaya/undraw_mobile_payments_edgf_zkw6u3.png" height="300" width="370">
        </div>
        <div class="col-6 mt-5 ">
            
            <div class="card">
                <h5 class="card-header font-weight-bold">LOGIN</h5>
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    ...
                                    {{-- <a class="btn btn-link" href="{{ '/loginOTP' }}">
                                        Login dengan No Hp
                                    </a> --}}
                            </div>
                        </div>
